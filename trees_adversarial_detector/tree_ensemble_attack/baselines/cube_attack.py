...
def binary_search_attack(attack, f, X, y, n_trials_attack, cleanup=True, printing_log=False):
    """
...
def exact_attack_stumps(f, X, y, printing_log=False):
...
class Cube(object):
    def __init__(self, model, norm_order, num_iterations=100, printing_log=False):
    ...
    def __call__(self, xi, yi):
        ...
        # 1-vs-all reduction.
        yf, deltas = binary_search_attack(cube_attack, self, X, y, self.num_iterations, cleanup=should_cleanup, printing_log=self.printing_log)
